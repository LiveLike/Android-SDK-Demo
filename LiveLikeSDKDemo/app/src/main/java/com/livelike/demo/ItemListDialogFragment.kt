...
import com.livelike.demo.databinding.FragmentItemListDialogListDialogItemBinding
import com.livelike.demo.databinding.FragmentItemListDialogListDialogBinding
...
class ItemListDialogFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        _binding?.list?.layoutManager = GridLayoutManager(context, 3)
